...
const TicketEdit = React.createClass({
  ...
  handleSubmit: function(e) {
    ...
    const MULTI_OPTION_FIELDS = ['incident_type'];
    const data = formToObject(this.form);
    MULTI_OPTION_FIELDS.forEach(mof => {
      if (typeof data[mof] === 'undefined') {
        data[mof] = [];
      }
      if (!Array.isArray(data[mof])) {
        data[mof] = [data[mof]];
      }
    });
  ...
  render: function() {
    ...
    return (
      ...
      <section
        ...
        key={this.props.implementingPartners.length}
      >
        <div className="modal__inner modal__form">
          ...
          >
            {isAdmin
              ? <div className="form__group">
                  ...
                  {_.map(ticketStatusLUT, (display, value) =>
                    <label
                      key={value}
                      className="form__option form__option--inline form__option--custom-radio"
                    >
                      <input
                        type="radio"
                        ...
                        value={value}
                        defaultChecked={
                          this.props.existingTicket.status === value
                        }
                      />
            ...
            {isAdmin
              ? <div className="form__group">
                  <label
                    className="form__label-dark"
                    htmlFor="form-ticket_title"
                  >
                    Title
                  </label>
                  <p className="form__help">
                    A short title that describes your incident.
                  </p>
                  <input
                    type="text"
            ...
            {isAdmin
              ? <div className="form__group">
                  ...
                  <select
                    ...
                    name="ip_assigned_id"
                    onChange={e => {
                      const ip = this.props.implementingPartners.find(
                        ip => ip.id === e.target.value
                      );
                      if (ip) {
            ...
            {isAdmin || isIP
              ? <div className="form__row">
                  <div className="form__group">
                    <label
                      className="form__label-dark"
                      htmlFor="form-ticket_ip_name"
                    >
                      Team Member Name
                    </label>
                    <p className="form__help">
                      The member of your organization/team who will be managing
                  ...
                  <div className="form__group">
                    <label
                      className="form__label-dark"
                      htmlFor="form-ticket_ip_contact"
                    >
                      Team Member E-mail
                    </label>
                    <p className="form__help">
                      An alternative email address to use for notifications
                      related to this ticket. (Optional)
                    </p>
                    <input
                      type="email"
                      ...
                      ref={thisInput => {
                        this.ticket_ip_contact = thisInput;
                      }}
            ...
            {isAdmin || isSP
              ? <div className="form__row">
                  <div className="form__group">
                    <label
                      className="form__label-dark"
                      htmlFor="form-ticket_sp_name"
                    >
                      Service Provider Name for This Ticket
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="form__group">
                    <label
                      className="form__label-dark"
                      htmlFor="form-ticket_sp_contact"
                    >
                      Service Provider Contact for This Ticket
                    </label>
                    <input
                      type="email"
                      ...
                      ref={thisInput => {
                        this.ticket_sp_contact = thisInput;
                      }}
            ...
            {isAdmin || isIP
              ? <div>
                  <div className="form__group">
                    <label
                      className="form__label-dark"
                      htmlFor="form-date_of_incident"
                    >
                      Date Incident was Identified
                    </label>
                    <p className="form__help">
                      The date when the incident occurred or was identified by
                    ...
                    <input
                      ...
                      defaultValue={this.props.existingTicket.date_of_incident.slice(
                        0,
                        10
                      )}
                    />
                  ...
                  <div className="form__group checkboxes-light form__group--medium">
                    ...
                    <p className="form__help">
                      The type of incident. (Choose all/any that apply.)
                    </p>
                    {incidentTypes.map(type =>
                      <label
                        className="form__option form__option--custom-checkbox"
                        key={'incident_type-' + type.name}
                      >
                        <input
                          type="checkbox"
                          name="incident_type"
                          value={type.name}
                          defaultChecked={this.props.existingTicket.incident_type.includes(
                            type.name
                          )}
                        />
                        <span className="form__option__text">
                  ...
                  <div className="form__group">
                    ...
                    <p className="form__help">
                      Provide a brief description of the incident. (CiviCDR
                      staff will follow up to collect more information.)
                    </p>
                    <textarea
                      id="form-description"
                  ...
                  <div className="form__group">
                    <label
                      className="form__label-dark"
                      htmlFor="form-steps_taken"
                    >
                      Steps Taken to Mitigate
                    </label>
                    <p className="form__help">
                      Provide information about any steps the affected parties
                      have already taken to address the issue or protect
                      themselves.
                    </p>
                    <textarea
                      id="form-steps_taken"
              ...
              <ul className="form__actions">
                <li className="form__actions-item">
                  <input
                    type="submit"
                    value="Save"
                    onClick={() => this.setState({ pathToRedirect: '/' })}
