...
import { createTicket, fetchImplementingPartners } from '../actions';
        ...
        <section className="inpage__body">
          <div className="inner">
            ...
            >
              ...
              <div className="form__group">
                <label className="form__label-dark" htmlFor="form-ticket_title">
                  Title
                </label>
              ...
              <div className="form__group">
                ...
                <p className="form__help">
                  The date when the incident occurred or was identified by the
                  Implementing Partner.
                </p>
                <input
                  type="date"
                ...
                <div className="form__group--xlarge">
                  {incidentTypes.map(type =>
                    ...
                    >
                      ...
                      <p className="form__option__description">
                        {type.description}
                      </p>
                      <span className="form__option__ui" />
                    </label>
              ...
              <div className="form__group">
                <label className="form__label-dark" htmlFor="form-description">
                  Description
                </label>
                <p className="form__help">
                  Provide a brief description of the incident. (CiviCDR staff
                  will follow up to collect more information.)
                </p>
                <textarea
                  id="form-description"
              ...
              <div className="form__group">
                <label className="form__label-dark" htmlFor="form-steps_taken">
                  Steps Taken to Mitigate
                </label>
                <p className="form__help">
                  Provide information about any steps the affected parties have
                  already taken to address the issue or protect themselves.
                </p>
                <textarea
                  id="form-steps_taken"
                  className="form__control"
                  ...
                  {isAdmin
                    ? <li className="form__actions-item">
                        <input
                          ...
                          className="button button--large button--secondary-bounded"
                        />
                      </li>
                    : ''}
                  <li className="form__actions-item">
